...
class Kraus_Test_Adminhtml_TestController extends Mage_Adminhtml_Controller_Action
{
    ...
    {  
        ...
        $this->_initAction()
            ...
            ->_addContent($this->getLayout()->createBlock('kraus_test/adminhtml_test_edit')->setData('action', $this->getUrl('*/*/save')))
            ->renderLayout();
    }
    ...
    public function saveAction()
    {
        if ($postData = $this->getRequest()->getPost()) {
            $model = Mage::getSingleton('kraus_test/test');
    ...
    protected function _initAction()
    {
        $this->loadLayout()
            ...
            ->_setActiveMenu('sales/foo_test_test')
